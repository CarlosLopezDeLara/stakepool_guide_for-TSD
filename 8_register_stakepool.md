...
1. 	Make sure you have access to:
    ...
    | `payment.addr`          | fundedn address linked to `stake` |
...
according to their delegated stake) to 1%, use the staking key we created [here](staking-key.md) to receive our rewards
